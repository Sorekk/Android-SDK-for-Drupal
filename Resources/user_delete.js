...
var btn_deleteuser = Titanium.UI.createButton (
{
  height:60,
  width:320,
  top:170,
...
btn_deleteuser.addEventListener('click',function(){uid=txt_Uid.value;user_delete(uid);});
curWindow.add(lbl_Uid);
curWindow.add(txt_Uid);
curWindow.add(btn_deleteuser);
